...
namespace Pharmacy.Migrations
{
    ...
    [Migration("20260822184545_AddChatSystem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pharmacy.Models.ApplicationUserOtp", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Pharmacy.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pharmacy.Models.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pharmacy.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pharmacy.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pharmacy.Models.CartItem", b =>
                {
                    b.HasOne("Pharmacy.Models.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("Pharmacy.Models.Chat", b =>
                {
                    b.HasOne("Pharmacy.Models.ApplicationUser", "Admin")
                        .WithMany("AdminChats")
                        .HasForeignKey("AdminId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Pharmacy.Models.ApplicationUser", "Customer")
            ...
            modelBuilder.Entity("Pharmacy.Models.ChatMessage", b =>
                {
                    b.HasOne("Pharmacy.Models.Chat", "Chat")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pharmacy.Models.ApplicationUser", "Sender")
